...
export default class Vista extends Component {
  render() {
    return (
        <Row className = 'fondoFiltroTag'>
            <Col s={3}/>
            <Col s={6}>
                <h2>Resultado para React</h2>
                <CardIdea nombreUsuario = 'Pedro Picapiedra' comentario = 'Es muy fácil crer apps usando React, me lleo sólo unas horas poder hacer una app sencilla.' tag1 = 'react' tag2 = 'app' tag3 = 'proyecto' likes = '6'/>
                ...
                <CardPublicacion usuario={"Lluvia Buendía"} likes={"23"} descripcion={"Asistiré a un hackaton donde usaremos react y probablemente react native, recomiendeneme donde puedo aprender rapido por favor."} reto1={"Realizar peticiones"} reto2={"Documentación"} reto3={"Requerimientos"} tag1={"react"} tag2={"App"} tag3={"JavaScript"} tag4={"grid"}/>
